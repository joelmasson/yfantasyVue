<template>
    <section>
        ...
        <router-link v-for="(matchup, i) in league.scoreboard.matchups" :key="i" :to="{ name:'Matchup', params: { game_id: $route.params.game_id, league_id:$route.params.league_id, week_num:matchup.week, matchup:matchup.teams[0].team_id+'-'+matchup.teams[1].team_id } }">
            <MatchupHeader :matchup="matchup"></MatchupHeader>
        </router-link>
    </section>
</template>
<script>
